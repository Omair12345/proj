...
var emptyStar,onestar,twoStars,displayStars;
...
function setup() 
{
  ...
  displayStars = createSprite(50,20,30,30)
  displayStars.scale = (0.2)
  displayStars.addAnimation("Empty", emptyStar)
  displayStars.addAnimation("One", onestar)
  displayStars.addAnimation("Two", twoStars)
  displayStars.changeAnimation("Empty")
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star,20)){
     star.visible = false
     displayStars.changeAnimation("One")
   }

   
   if(collide(fruit,star2,40)){
    star2.visible = false
    displayStars.changeAnimation("Two")
  }
}
